...
public class EventDetailSortByDateProfile implements java.util.Comparator<ItemFeedbackFRecente>{

    @Override
    public int compare(ItemFeedbackFRecente customerEvents1, ItemFeedbackFRecente customerEvents2) {
